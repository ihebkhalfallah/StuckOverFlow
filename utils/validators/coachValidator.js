...
export const getCoachValidator = [
  check("id").isMongoId().withMessage("Invalid coach id format"),
  validatorMiddleware,
];

export const createCoachValidator = [
...
export const updateCoachValidator = [
...
export const deleteCoachValidator = [
  check("id").isMongoId().withMessage("Invalid coach id format"),
  validatorMiddleware,
];
